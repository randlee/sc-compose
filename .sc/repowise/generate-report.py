...
h1 = load_json("/tmp/repowise-health-compose.json")
rt = load_json("/tmp/repowise-refactoring-targets.json")
dc = load_json("/tmp/repowise-dead-code.json")
k = h1['kpis']
...
blank()
w("**Version:** v1.2.0 | **Commit:** b5d9b47 | **Generated:** 2026-07-22")
...
with open("/tmp/repowise-final.md", "w") as f:
    f.write("\n".join(out))

print(f"Wrote {len(out)} lines to /tmp/repowise-final.md")
