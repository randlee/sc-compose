...
QA scope. Use `review_type: "plan_gate"`.
...
```json
{
  ...
  "commits": "HEAD",
  "deliverables": [
    "Plan and sprint docs are hardened and ready for implementation dispatch"
  ],
  "references": [
...
Populate `sprint_doc` and `changed_scope` by listing the phase plan and every
