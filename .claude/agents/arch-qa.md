...
Flag repo-significant team literals such as `sc-compose` unless the test clearly
...
Flag repo-significant identities such as `comp` unless the test clearly
  ...
  "findings": [
    {
      ...
      "file": "crates/sc-compose/src/module.rs",
      "line": 46,
