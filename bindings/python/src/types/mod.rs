...
pub(crate) use results::{
    ...
    PyExtractionOccurrence, PyExtractionPathSegment, PyExtractionReport, PyExtractionSource,
    PyFrontmatter, PyFrontmatterInitResult, PyInitResult, PyParsedTemplate, PyRenderedArtifact,
    PyRenderer, PyResolveResult, PyValidationReport, PyVerifyResult,
};
...
pub(crate) fn register(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_class::<PyExtractionPathSegment>()?;
